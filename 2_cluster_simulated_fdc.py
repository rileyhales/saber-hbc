...
km.to_pickle(f'data_2_cluster_simulations/fdc_eucl_kmeans_{n_clusters}cluster_model.pickle')
...
plt.tight_layout()
# plt.show()
fig.savefig(f'data_2_cluster_simulations/fdc_eucl_kmeans_{n_clusters}cluster.png')
