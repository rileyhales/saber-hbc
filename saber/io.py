...
table_downstream_prop = 'assign_table_downstream_prop.parquet'
table_upstream_prop = 'assign_table_upstream_prop.parquet'
...
def get_table_path(workdir: str, table_name: str) -> str:
    ...
    elif table_name == 'downstream_prop':
        return os.path.join(workdir, dir_tables, table_downstream_prop)
    elif table_name == 'upstream_prop':
        return os.path.join(workdir, dir_tables, table_upstream_prop)
